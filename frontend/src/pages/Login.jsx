    ...
    <div className="auth-page">
      <div className="auth-card glass-card animate-fade-in-up">
        ...
        <div className="auth-card__footer">
          <p>Don't have an account? <Link to="/signup" className="fw-semibold" style={{ color: 'var(--primary)' }}>Sign up</Link></p>
        </div>
      </div>

      {/* Google Services Badge */}
      <div className="auth-services animate-fade-in" style={{ animationDelay: '0.5s' }}>
